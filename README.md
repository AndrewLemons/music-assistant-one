...
The first library page shows up to 60 items per category; global search searches the configured providers. The queue view displays up to 100 entries. Pagination and detailed album/artist browsing are follow-up work.
...
- Native Mac sidebar and keyboard commands; adaptive iPhone/iPad tabs; Liquid Glass mini player and system sheets.
